...
@router.get("/", response_model=List[station_schema.Station], include_in_schema=False)
...
@router.get("/{station_id}", response_model=station_schema.Station, include_in_schema=False)
...
@router.put("/", response_model=station_schema.Station, include_in_schema=False)
...
@router.delete("/{station_id}", include_in_schema=False)
